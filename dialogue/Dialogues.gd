...
var PORTRAIT_TEST_1 = preload("res://assets/images/portraits/butler.png")
var PORTRAIT_TEST_2 = preload("res://assets/images/portraits/defaultprofile2.png")

func _ready():
	IntroductoryText = DialogueText.new()
	IntroductoryText.dialogue_index = 2
	IntroductoryText.setContent([
